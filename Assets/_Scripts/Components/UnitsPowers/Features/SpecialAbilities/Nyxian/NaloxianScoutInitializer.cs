...
{
	/// <summary>
	/// Initializer for the <see cref="NaloxianScout"/> scriptable object.
	/// </summary>
	internal sealed class NaloxianScoutInitializer : ScriptableObjectInitializer<NaloxianScout, IVFXPoolingManager>
	{
		#if UNITY_EDITOR
		/// <summary>
