...
{
	/// <summary>
	/// Initializer for the <see cref="AdvancedAdamantiumArmor"/> scriptable object.
	/// </summary>
	internal sealed class AdvancedAdamantiumArmorInitializer : ScriptableObjectInitializer<AdvancedAdamantiumArmor, IVFXPoolingManager>
	{
		#if UNITY_EDITOR
		/// <summary>
