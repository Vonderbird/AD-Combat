...
{
	/// <summary>
	/// Initializer for the <see cref="ReuniteArmor"/> scriptable object.
	/// </summary>
	internal sealed class ReuniteArmorInitializer : ScriptableObjectInitializer<ReuniteArmor, IVFXPoolingManager>
	{
		#if UNITY_EDITOR
		/// <summary>
