...
{
	/// <summary>
	/// Initializer for the <see cref="IronBreakerElite"/> scriptable object.
	/// </summary>
	internal sealed class IronBreakerEliteInitializer : ScriptableObjectInitializer<IronBreakerElite, IVFXPoolingManager>
	{
		#if UNITY_EDITOR
		/// <summary>
