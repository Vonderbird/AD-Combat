...
{
	/// <summary>
	/// Initializer for the <see cref="ArtilleryUpgrade"/> scriptable object.
	/// </summary>
	internal sealed class ArtilleryUpgradeInitializer : ScriptableObjectInitializer<ArtilleryUpgrade, IVFXPoolingManager>
	{
		#if UNITY_EDITOR
		/// <summary>
