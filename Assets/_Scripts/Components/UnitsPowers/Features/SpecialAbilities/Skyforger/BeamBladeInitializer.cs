...
{
	/// <summary>
	/// Initializer for the <see cref="BeamBlade"/> scriptable object.
	/// </summary>
	internal sealed class BeamBladeInitializer : ScriptableObjectInitializer<BeamBlade, IVFXPoolingManager>
	{
		#if UNITY_EDITOR
		/// <summary>
