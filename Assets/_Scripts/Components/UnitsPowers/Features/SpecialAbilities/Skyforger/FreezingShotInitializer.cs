...
{
	/// <summary>
	/// Initializer for the <see cref="FreezingShot"/> scriptable object.
	/// </summary>
	internal sealed class FreezingShotInitializer : ScriptableObjectInitializer<FreezingShot, IVFXPoolingManager>
	{
		#if UNITY_EDITOR
		/// <summary>
