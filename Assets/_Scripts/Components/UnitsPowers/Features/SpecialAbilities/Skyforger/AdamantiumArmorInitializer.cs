...
{
	/// <summary>
	/// Initializer for the <see cref="AdamantiumArmor"/> scriptable object.
	/// </summary>
	internal sealed class AdamantiumArmorInitializer : ScriptableObjectInitializer<AdamantiumArmor, IVFXPoolingManager>
	{
		#if UNITY_EDITOR
		/// <summary>
