...
{
	/// <summary>
	/// Initializer for the <see cref="Thunderdome"/> scriptable object.
	/// </summary>
	internal sealed class ThunderdomeInitializer : ScriptableObjectInitializer<Thunderdome, IVFXPoolingManager>
	{
		#if UNITY_EDITOR
		/// <summary>
