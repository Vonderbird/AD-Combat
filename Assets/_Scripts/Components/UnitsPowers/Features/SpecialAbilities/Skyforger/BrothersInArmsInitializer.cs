...
{
	/// <summary>
	/// Initializer for the <see cref="BrothersInArms"/> scriptable object.
	/// </summary>
	internal sealed class BrothersInArmsInitializer : ScriptableObjectInitializer<BrothersInArms, IVFXPoolingManager>
	{
		#if UNITY_EDITOR
		/// <summary>
