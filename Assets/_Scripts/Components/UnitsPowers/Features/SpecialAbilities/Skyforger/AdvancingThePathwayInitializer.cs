...
{
	/// <summary>
	/// Initializer for the <see cref="AdvancingThePathway"/> scriptable object.
	/// </summary>
	internal sealed class AdvancingThePathwayInitializer : ScriptableObjectInitializer<AdvancingThePathway, IVFXPoolingManager>
	{
		#if UNITY_EDITOR
		/// <summary>
