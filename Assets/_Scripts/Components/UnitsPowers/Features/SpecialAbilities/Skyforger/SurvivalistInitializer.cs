...
{
	/// <summary>
	/// Initializer for the <see cref="Survivalist"/> scriptable object.
	/// </summary>
	internal sealed class SurvivalistInitializer : ScriptableObjectInitializer<Survivalist, IVFXPoolingManager>
	{
		#if UNITY_EDITOR
		/// <summary>
