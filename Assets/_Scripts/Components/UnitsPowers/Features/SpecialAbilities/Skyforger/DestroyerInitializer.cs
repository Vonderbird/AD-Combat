...
{
	/// <summary>
	/// Initializer for the <see cref="Destroyer"/> scriptable object.
	/// </summary>
	internal sealed class DestroyerInitializer : ScriptableObjectInitializer<Destroyer, IVFXPoolingManager>
	{
		#if UNITY_EDITOR
		/// <summary>
