...
{
	/// <summary>
	/// Initializer for the <see cref="GroundPound"/> scriptable object.
	/// </summary>
	internal sealed class GroundPoundInitializer : ScriptableObjectInitializer<GroundPound, IVFXPoolingManager>
	{
		#if UNITY_EDITOR
		/// <summary>
