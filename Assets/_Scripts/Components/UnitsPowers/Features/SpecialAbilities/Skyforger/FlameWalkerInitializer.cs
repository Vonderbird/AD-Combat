...
{
	/// <summary>
	/// Initializer for the <see cref="FlameWalker"/> scriptable object.
	/// </summary>
	internal sealed class FlameWalkerInitializer : ScriptableObjectInitializer<FlameWalker, IVFXPoolingManager>
	{
		#if UNITY_EDITOR
		/// <summary>
