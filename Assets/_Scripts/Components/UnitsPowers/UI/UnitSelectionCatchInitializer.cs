...
{
	/// <summary>
	/// Initializer for the <see cref="UnitSelectionCatch"/> component.
	/// </summary>
	internal sealed class UnitSelectionCatchInitializer : Initializer<UnitSelectionCatch, IUnitStatsUIPanelManager>
	{
		#if UNITY_EDITOR
		/// <summary>
		...
		{
			public IUnitStatsUIPanelManager UnitStatsUIPanelManager = default;
		}
		#endif
	}
}
