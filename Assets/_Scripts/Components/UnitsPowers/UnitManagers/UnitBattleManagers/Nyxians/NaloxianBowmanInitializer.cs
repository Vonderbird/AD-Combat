...
{
	/// <summary>
	/// Initializer for the <see cref="NaloxianBowman"/> component.
	/// </summary>
	internal sealed class NaloxianBowmanInitializer : Initializer<NaloxianBowman, SpecialAbilityCollection>
	{
		#if UNITY_EDITOR
		/// <summary>
