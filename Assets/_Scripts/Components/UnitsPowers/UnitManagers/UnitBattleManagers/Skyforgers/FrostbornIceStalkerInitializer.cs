...
{
	/// <summary>
	/// Initializer for the <see cref="FrostbornIceStalker"/> component.
	/// </summary>
	internal sealed class FrostbornIceStalkerInitializer : Initializer<FrostbornIceStalker, SpecialAbilityCollection>
	{
		#if UNITY_EDITOR
		/// <summary>
