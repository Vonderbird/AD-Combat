...
{
	/// <summary>
	/// Initializer for the <see cref="ThunderkinArtilleryTank"/> component.
	/// </summary>
	internal sealed class ThunderkinArtilleryTankInitializer : Initializer<ThunderkinArtilleryTank, SpecialAbilityCollection>
	{
		#if UNITY_EDITOR
		/// <summary>
