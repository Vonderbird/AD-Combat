...
{
	/// <summary>
	/// Initializer for the <see cref="FrostbornHunter"/> component.
	/// </summary>
	internal sealed class FrostbornHunterInitializer : Initializer<FrostbornHunter, SpecialAbilityCollection>
	{
		#if UNITY_EDITOR
		/// <summary>
