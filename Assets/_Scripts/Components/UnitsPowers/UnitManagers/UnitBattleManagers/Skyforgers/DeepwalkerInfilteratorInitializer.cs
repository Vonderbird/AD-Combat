...
{
	/// <summary>
	/// Initializer for the <see cref="DeepwalkerInfilterator"/> component.
	/// </summary>
	internal sealed class DeepwalkerInfilteratorInitializer : Initializer<DeepwalkerInfilterator, SpecialAbilityCollection>
	{
		#if UNITY_EDITOR
		/// <summary>
