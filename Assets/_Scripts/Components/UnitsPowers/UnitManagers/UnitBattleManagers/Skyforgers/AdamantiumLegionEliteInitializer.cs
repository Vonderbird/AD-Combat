...
{
	/// <summary>
	/// Initializer for the <see cref="AdamantiumLegionElite"/> component.
	/// </summary>
	internal sealed class AdamantiumLegionEliteInitializer : Initializer<AdamantiumLegionElite, SpecialAbilityCollection>
	{
		#if UNITY_EDITOR
		/// <summary>
		...
		{
			public SpecialAbilityCollection SpecialAbilitys = default;
		}
		#endif
	}
}
