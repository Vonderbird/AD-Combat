...
{
	/// <summary>
	/// Initializer for the <see cref="ThunderkinWarWagon"/> component.
	/// </summary>
	internal sealed class ThunderkinWarWagonInitializer : Initializer<ThunderkinWarWagon, SpecialAbilityCollection>
	{
		#if UNITY_EDITOR
		/// <summary>
