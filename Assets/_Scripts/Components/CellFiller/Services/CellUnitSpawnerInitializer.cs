...
{
	/// <summary>
	/// Initializer for the <see cref="CellUnitSpawner"/> component.
	/// </summary>
	internal sealed class CellUnitSpawnerInitializer : Initializer<CellUnitSpawner, IWaveTimer>
	{
		#if UNITY_EDITOR
		/// <summary>
		...
		{
			public IWaveTimer WaveTimer = default;
		}
		#endif
	}
}
