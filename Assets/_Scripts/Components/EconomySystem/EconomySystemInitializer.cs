...
{
	/// <summary>
	/// Initializer for the <see cref="EconomySystem"/> component.
	/// </summary>
	internal sealed class EconomySystemInitializer : Initializer<EconomySystem, FactionEconomiesCollection, IIncomeSourceFactory>
	{
		#if UNITY_EDITOR
		/// <summary>
		...
		{
			public FactionEconomiesCollection FactionEconomiesCollection = default;
		}
		#endif
	}
}
