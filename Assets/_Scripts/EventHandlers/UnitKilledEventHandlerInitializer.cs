...
{
	/// <summary>
	/// Initializer for the <see cref="UnitKilledEventHandler"/> component.
	/// </summary>
	internal sealed class UnitKilledEventHandlerInitializer : Initializer<UnitKilledEventHandler, IEconomySystem>
	{
		#if UNITY_EDITOR
		/// <summary>
