            ...
            switch ((InputMode)input.targetMode)
            {
                ...
                case InputMode.setComponentTarget:
                    ...
                    sourceEntity.EntityTargetComponents[input.code].SetTargetLocal(
                        new SetTargetInputData
                        {
                            ...
                            ignoreLOS = setTargetBooleans.HasFlag(SetTargetInputDataBooleans.ignoreLOS),
                            allowTerrainAttack = setTargetBooleans.HasFlag(SetTargetInputDataBooleans.allowTerrainAttack)
                        });
                    break;
                ...
                case InputMode.launchComponentAction:
                    ...
                    sourceEntity.EntityComponents[input.code].LaunchActionLocal(
                        ...
                        new SetTargetInputData
                        {
                            ...
                            ignoreLOS = launchActionBooleans.HasFlag(SetTargetInputDataBooleans.ignoreLOS),
                            allowTerrainAttack = launchActionBooleans.HasFlag(SetTargetInputDataBooleans.allowTerrainAttack)
                        });
                    break;
                ...
                case InputMode.attack:
                    ...
                    attackMgr.LaunchAttackLocal(new LaunchAttackData<IEntity>
                    {
                        ...
                        mode = (LaunchAttackTypeMode)input.intValues.Item2,
                        attackTypeCode = input.opCode,
                        ...
                        ignoreLOS = launchAttackBooleans.HasFlag(LaunchAttackBooleans.ignoreLOS),
                    });
                    break;
