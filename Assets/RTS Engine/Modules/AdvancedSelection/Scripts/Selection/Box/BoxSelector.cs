...
namespace RTSEngine.Selection.Box
{
    public class BoxSelector : MonoBehaviour, IBoxSelector
    {
        ...
        [SerializeField, Tooltip("Enable this field to allow the local player to start drawing the selection box even when the cursor is on UI elements.")]
        private bool canStartDrawingOnUI = false;
