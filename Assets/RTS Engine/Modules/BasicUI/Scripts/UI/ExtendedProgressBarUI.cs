...
namespace RTSEngine.UI
{
    ...
    public class ExtendedProgressBarUI
    {
        ...
        [SerializeField, Tooltip("Includes a UI Image component used to display the transition progress bar. This bar is only for visual purposes.")]
        private RectTransform transitionBar = null;
