...
public class MaterialHoverSwitch : MonoBehaviour
{
    ...
    void OnMouseDown()
    {
        ...
        else if (!deleteMode && SpawnButtonHoverController.selectedUnitPrefab != null && !isOccupied)
        {
            ...
            // Initialize the unit with any necessary components
            InitializeUnitComponents(spawnedUnit);
        }
    }

    void InitializeUnitComponents(GameObject unit)
    {
        //var movementComponent = unit.GetComponent<IMovementComponent>();
        //if (movementComponent != null)
        //{
        //    movementComponent.InitializeMovement(); // Hypothetical method to initialize movement
        //}

        //var attackComponent = unit.GetComponent<IAttackComponent>();
        //if (attackComponent != null)
        //{
        //    attackComponent.InitializeAttack(); // Hypothetical method to initialize attack
        //}

        //var healthComponent = unit.GetComponent<IHealthComponent>();
        //if (healthComponent != null)
        //{
        //    healthComponent.InitializeHealth(); // Hypothetical method to initialize health
        //}
    }
