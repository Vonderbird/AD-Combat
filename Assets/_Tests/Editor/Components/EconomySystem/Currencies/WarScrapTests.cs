...
namespace ADC.Editor.Tests
{
    ...
    public class WarScrapTests
    {
        ...
        {
            var warScrap = new WarScrap(50.5m);
            Assert.AreEqual(50.5m, warScrap.Value);
        }

        [Test]
        public void ImplicitConversion_ToDecimal_ReturnsValue()
        {
            var warScrap = new WarScrap(30m);
            decimal value = warScrap;
        ...
        {
            var b1 = new WarScrap(a);
            var b2 = new WarScrap(b);
        ...
        {
            var b1 = new WarScrap(100m);
            var b2 = new WarScrap(30m);
        ...
        {
            var b = new WarScrap(10m);
            Assert.IsTrue(b.Equals(10));
            Assert.IsTrue(b.Equals(10.0f));
            Assert.IsTrue(b.Equals(new WarScrap(10.0m)));
            Assert.IsTrue(b.Equals((object)new WarScrap(10.0m)));
