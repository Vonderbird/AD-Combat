...
namespace ADC
{
    ...
    public class ExtendedHoverHealthBar : HoverHealthBarBase
    {
        ...
        protected ExtendedProgressBarUI healthBar = new ExtendedProgressBarUI();
        ...
        private void UpdateHealthBar()
        {
            ...
            print($"Entity.Health.CurrHealth: {Entity.Health.CurrHealth}");
